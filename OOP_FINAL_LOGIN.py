...
#BUTTONS
login_button = c.create_button(frame1, 12, 'Login', 'blue', 'black', 'hand2', 1, 'Sitka Text', 8, 65, 250, 100, 40, LogIn)
register_button = c.create_button(frame1, 12, 'Register', '#D8D8D8', 'yellow', 'hand2', 1, 'Sitka Text', 8, 185, 250, 100, 40, Open_register)
